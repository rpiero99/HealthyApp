                      ...
                      child: MaterialButton(
                        ...
                        onPressed: () async {
                          if (widget.nomeController.text.isNotEmpty &&
                            ...
                            widget.pastoSelected.nome =
                                widget.nomeController.text;
                            widget.pastoSelected.descrizione =
                                widget.descrizioneController.text;
                            widget.pastoSelected.quantita =
                                int.parse(widget.quantitaController.text);
                            widget.pastoSelected.calorie =
                                int.parse(widget.calorieController.text);
                            widget.pastoSelected.categoria =
                                Constants.getCategoriaFromString(
                                    widget.comboItem);
                            widget.pastoSelected.type =
                                widget.tipoController.text;
                            Constants.controller
                                .updatePasto(widget.pastoSelected);
                          ...
                          widget.comboItem = CategoriaPasto.values[0]
                              .toString()
                              .split('.')
                              .last;
                          Navigator.pop(context);
