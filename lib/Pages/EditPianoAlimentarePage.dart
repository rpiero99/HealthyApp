                          ...
                          onPressed: () async {
                            if(dataInizioController.text.isNotEmpty && dataFineController.text.isNotEmpty
                              ...
                              if(dataInizio.isAfter(dataFine)){
                                ...
                                pianoAlimentare?.descrizione = descrizioneController.text;
                                pianoAlimentare?.dataInizio = DateTime.parse(dataInizioController.text);
                                pianoAlimentare?.dataFine = DateTime.parse(dataFineController.text);
                                Constants.controller.updatePianoAlimentare(pianoAlimentare!);
                                ScaffoldMessenger.of(context).showSnackBar(
                                    Constants.createSnackBar(
