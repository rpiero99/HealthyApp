...
class AddPianoAlimentarePage extends StatelessWidget {
                      ...
                      onPressed: () async {
                        if (dataInizioController.text.isNotEmpty &&
                          ...
                          if (dataInizio.isAfter(dataFine)) {
                            ...
                            utente = await Constants.controller
                                .getUtenteById(Constants.getCurrentIdUser()!);
                            pianoAlimentare = Constants.controller
                                .createPianoAlimentare(dataFine, dataInizio,
                                    descrizioneController.text, utente!);
  ...
  void clearFieldsPasto() {
    ...
    categoriaComboItem = CategoriaPasto.values[0]
        .toString()
        .split('.')
        .last
        .replaceAll("_", " ");
        ...
        content: Column(children: [
          ...
          TextField(
            ...
            decoration: const InputDecoration(
                hintText: "Calorie approssimative del pasto.."),
          ),
          TextField(
          ...
          TextButton(
            ...
            onPressed: () {
              if (nomePastoController.text.isNotEmpty &&
                ...
                pasti.add(Pasto.pianoAlimentare(
                    Constants.getCategoriaFromString(categoriaComboItem!),
